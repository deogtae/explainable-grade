...
- A 등급 평가: 매우 드물게 접하는 문제 (A 등급 문제)의 50% 이상을 해결할 수 있다. (즉, 대부분의 문제를 풀 수 있다.)
...
- 문제의 등급을 명료하게 구분되도록 문제를 출제하게 되어 시험의 변별력을 높여준다.

- S 등급 문제를 마음대로 낼 수 있다.

    수강생들에게 난이도 높은 문제들에게 접하고 인지하고 도전할 기회를 주며 보너스 점수의 성격이기 때문에 부담없이 출제할 수 있다. 또한, 수강생들이 꼼꼼하게 모든 문제를 푸는 노력보다는 난이도 높은 문제를 푸는 실력을 배양하도록 권장하는 효과를 준다.
...
이렇게 평가하더라도 기존의 상대평가와 크게 다른 점은 단순한 상대 평가가 아니라 여전히 난이도 혹은 접하는 빈도라는 의미에 기반한 평가라는 것이다.
